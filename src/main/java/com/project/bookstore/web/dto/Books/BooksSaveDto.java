package com.project.bookstore.web.dto.Books;
...
public class BooksSaveDto {
    ...
    @Builder
    public BooksSaveDto(String ISBM, String bookName, String bookAut, String bookTrans, String bookHouse, Date bookDate, String bookCov, int bookPri, String bookGen, String bookDet) {
        this.ISBM = ISBM;
